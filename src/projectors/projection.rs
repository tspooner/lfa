...
use super::{ActivationT, IndexT, DenseT, SparseT, IndexSet};
...
impl PartialEq<Projection> for Projection {
    fn eq(&self, rhs: &Projection) -> bool {
        ...
        match (self, rhs) {
            ...
            _ => unimplemented!("Cannot check equality of dense/sparse with no knowledge of the \
...
impl Add<Projection> for Projection {
    ...
    fn add(self, rhs: Projection) -> Projection {
        ...
        match (self, rhs) {
            ...
            _ => unimplemented!("Cannot combine dense/sparse with no knowledge of the full \
    ...
    fn index(&self, idx: usize) -> &f64 {
        match self {
            ...
            &Projection::Sparse(ref active_indices) =>
                if idx < active_indices.len() { &1.0 } else { &0.0 },
        }
    }
}
